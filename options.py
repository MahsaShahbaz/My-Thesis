...
def args_parser(defaults=None):
    ...
    #DP argument for Laplace
    parser.add_argument('--clipping_threshold',type=float,default=1.0,help='Clipping threshold for gradient clipping, serving as sensitivity for DP')
    parser.add_argument('--epsilon', type=float, default=0.50, help='Epsilon, noise level')
    ...
    #MIA
    parser.add_argument('--num_test_samples', type=int, default=500, help='Number of samples in the test dataset')
    parser.add_argument('--num_member_samples', type=int, default=300, help='Number of samples in the member dataset')
